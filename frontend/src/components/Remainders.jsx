  ...
  return (
    <div className="mx-2">
      ...
      <div className="shadow-xl h-80 bg-[#eeeded] w-80 rounded-3xl mx-10">
        ...
        <p className="pl-6 text-md text-gray-500">Norem ipsum dolor sit amet, consectetur adipiscing elit.<br />Nunc.</p>
        <p className="text-[#88C343] pl-6 mt-2 cursor-pointer transition-all duration-200 hover:underline">See all</p>
