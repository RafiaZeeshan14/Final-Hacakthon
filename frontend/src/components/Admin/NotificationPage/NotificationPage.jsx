    ...
    const notifications = [
        {
            ...
            message: "A new student has enrolled in the Web Development course.",
            date: "2024-08-09",
            isRead: false
        },
        {
            ...
            message: "Faculty meeting scheduled for today at 2:00 PM.",
            date: "2024-08-09",
            isRead: true
        },
        {
            ...
            message: "The budget for the upcoming semester needs your approval.",
            date: "2024-08-08",
            isRead: false
        },
        {
            ...
            message: "A proposal for the new AI course has been submitted for review.",
            date: "2024-08-07",
            isRead: true
        },
        {
            ...
            message: "Scheduled system maintenance will occur on 2024-08-10.",
            date: "2024-08-06",
            isRead: false
        },
        {
            ...
            message: "There are 3 leave requests pending your approval.",
            date: "2024-08-05",
            isRead: false
        },
        {
            ...
            message: "The annual report is due for submission by 2024-08-15.",
            date: "2024-08-03",
            isRead: true
        },
        {
            ...
            message: "You have received new feedback from the student council.",
            date: "2024-08-01",
            isRead: true
        },
        {
            ...
            message: "Staff performance reviews are scheduled for next week.",
            date: "2024-07-30",
            isRead: true
        },
        {
            id: 10,
            title: "Policy Update",
            message: "A new update to the campus security policy has been released.",
            date: "2024-07-29",
            isRead: true
        },
    ];
